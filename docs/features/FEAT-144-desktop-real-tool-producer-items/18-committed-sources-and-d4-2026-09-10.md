...
本地来源已按授权顺序提交，未推送、未打 tag、未部署。当前仅源码、兼容 reader 与安全定向检查通过；canonical 和真实 D4 尚未运行。历史检查保留原适用范围，AC-004 为 OWNER_EXCLUDED / NOT RUN，活动9项 AC 尚未关闭。
...
接下来运行标准 canonical，并按真实事实追加验收结果。来源提交、日常启动、真实 D4、推送分别记录，任何阶段不代替其它阶段。
