...
| EVID-F144-001 | Sorftime真实MCP服务来源、原生复用与前置边界 | FEAT-144当前四文件、13连接闭环及共用台账；原失败/备选历史分别保留 | 操作7/8固定0.144.6初始化ready/返回97工具；8/10元数据、模型/业务0；连接阻塞关闭，用户已排除业务失败场景并授权业务10次；D0按新范围实跑PASS；产品/GS-004/D4 NOT RUN |
...
| GS-004 Tool 成功/失败 | `owner-approved-inference` | 固定Runtime原生接入/inputSchema已验证；秘密/审批/结果/reader产品适配未实施，真实D4 NOT RUN | EVID-SCHEMA-003/006、EVID-HC-002、EVID-F144-001 | FEAT-144 |
