...
- ADR/Decision 结论：ADR-0013/0014/0015/0016与DEC-126-011/012/016/017/018/019/020/021/022/023/024均已Accepted；Chat/App Shell Pattern已批准。DEC-126-023方案C已关闭Q-017，DEC-126-024已批准content-free replacement并通过G2A重审。
- G2A/local 结论：`29317b6426578749dc698fc2ad32b986ee5c8e9f`是新的唯一source-contract candidate；`c000a0245acb5c3f7ead5d2a877fb60c281c588c`仅为未修改的历史remote candidate，Draft PR与远端状态不变。S4/S5/S6保持`Conditional / Corrective Closure Required`，LIA-126-002保持Paused，G3 Partial，G4/G6 Pending；恢复Foundation Corrective Closure须另行明确授权，S7–S11继续禁止。
- 架构 Owner：段成威。
...
| R-126-017 | Public Tasks arbitrary `input`使conversation正文进入PostgreSQL或response | high | critical | DEC-126-023方案C；closed contract schema/fixture与ADR-0013同向；provider/consumer conformance；route保持off | replacement canonical fixture、generated DTO、repository payload scan | source mitigation与G2A重审已在`29317b...`完成；LIA-126-002仍暂停，后续runtime conformance须另行授权 | 段成威 | source mitigated and approved / implementation validation pending |
...
| Public Tasks input / G2A re-review | 段成威 | DEC-126-023/024 Accepted；Q-017 Resolved；G2A Re-review Passed | 2026-08-02 | `29317b6426578749dc698fc2ad32b986ee5c8e9f`为新的唯一candidate；`c000a024`仅为历史远端候选；LIA-126-002仍暂停 |
