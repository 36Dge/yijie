# FEAT-126 本地启动、停止与恢复 Runbook（LIA-126-016/S10B-R3 Authorized / NOT RUN，G3 Partial）

> DEC-126-022将本需求冻结为Local-only Delivery。Owner已接受DEC-126-052 Option A：S10BM1 Closure Passed、S10B-BLK-003 Closed。随后形成clean Governance checkpoint `441663faf7d505015f03d572c8e9f30b3ba1a2df`，Owner再单独批准LIA-126-016/S10B-R3一次fresh执行。当前Authorized / NOT RUN；本文不授权S11、MiniMax、default activation或发布。
...
| yijie governance | DEC-126-052 clean Closure checkpoint / no tag | local `441663faf7d505015f03d572c8e9f30b3ba1a2df`；parent `9db41b03072f5d427c61fa832d22e94f3e8ce02c`；remote remains `650254b3c009c4098f7d7b2d415ed8082b0139fa` | FEAT-126 governance files only | package/strict/G2A/YAML/lint/test/diff PASS | clean local/not pushed；LIA-126-016 separately approved afterward and remains NOT RUN |
...
- [ ] G4仍需执行已单独批准的LIA-126-016并通过完整fresh S10B Closure；DEC-126-052只关闭BLK-003，R3当前NOT RUN
...
| 2026-08-05 | Governance checkpoint / LIA-126-016 | DEC-126-052 Accepted overlay形成clean local checkpoint，随后Owner单独批准S10B-R3 | Governance `441663faf7d505015f03d572c8e9f30b3ba1a2df`；six implementation pins unchanged | AUTHORIZED / NOT RUN / ONE FRESH EXECUTION ONLY | no container/service/flag/model/remote action；S11仍未授权 |
