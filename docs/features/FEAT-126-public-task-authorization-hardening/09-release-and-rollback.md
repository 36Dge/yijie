...
| 12 | S10E Compose/isolated identity准备 | local Infra + user-level plugin discovery | separately approved operator | DEC-126-038 Accepted + explicit S10E authorization | PASS；DEC-126-039 Closure Candidate，Infra `99e50d8…6baf` | restore link backup；stop exact run；volume deletion separately approved |
...
| Prepare S10E environment | 备份/修复用户Compose plugin link；新`feat-126-s10`run-scoped profile的validate/prepare/status/stop | local owner | EXECUTED / PASS；DEC-126-039 acceptance pending | Infra `99e50d8…6baf` + S10E manifest |
