...
| 字段 | 内容 |
|---|---|
| 状态 | G1 Passed / G2 Passed / G2A Re-review Passed / S4–S9 Closure Passed / DEC-126-036 Accepted / G3 Partial |
| 需求负责人 | 段成威 |
...
| G3 本地切片完成 | 未排期 | 段成威 | Partial：S4–S9 Closure已接受；S10–S11仍未授权/未实施 |
