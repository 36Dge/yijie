"""GET-only comparison of the exact pre-existing screenshot workflow after theme 26."""
...
AFTER = HERE / 'screenshot-workflow-after-26.json'
COMPARISON = HERE / 'screenshot-workflow-comparison-26.json'
...
def main():
    ...
    c.require(activation['manifest_sha256'].startswith('72575009') and activation['source_digest'].startswith('236d3628'), 'Expected theme candidate differs')
    state = c.read_state()
