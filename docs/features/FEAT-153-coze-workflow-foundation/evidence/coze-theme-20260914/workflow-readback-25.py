...
EXPECTED_MANIFEST = '062565c6cfe993f1676a72b4a7e4249d228c628484d75c1ca8b00c440feee147'
EXPECTED_SOURCE = '168c5814d41834ce66494ae61d25bb179be1b7bf6cb70dd4c9b127403177c2b3'

def main():
    stage = sys.argv[1] if len(sys.argv) == 2 else ''
    r.c.require(stage in ['saved-draft25', 'final-runs25', 'final-workflow25', 'after-normal-restart25'], 'Explicit snapshot stage required')
    ...
    r.c.require(activation['manifest_sha256'] == EXPECTED_MANIFEST and activation['source_digest'] == EXPECTED_SOURCE, 'Expected canonical 25 activation differs')
